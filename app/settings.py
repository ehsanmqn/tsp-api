...
MESSAGE_BROKER_USERNAME = os.environ.get('MESSAGE_BROKER_USERNAME', 'admin')
MESSAGE_BROKER_PASSWORD = os.environ.get('MESSAGE_BROKER_PASSWORD', 'admin')
TSP_INPUT_QUEUE = os.environ.get('TSP_INPUT_QUEUE', 'TSP_INPUT_QUEUE')
TSP_OUTPUT_QUEUE = os.environ.get('TSP_OUTPUT_QUEUE', 'TSP_OUTPUT_QUEUE')
